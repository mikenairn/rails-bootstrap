# RailsAdmin config file. Generated on April 19, 2012 10:19
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rails Bootstrap', 'Admin']
  ...
  # config.excluded_models = [Admin, Devise::Oauth2Providable::AccessToken, Devise::Oauth2Providable::AuthorizationCode, Devise::Oauth2Providable::Client, Devise::Oauth2Providable::RefreshToken, Product, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Admin, Devise::Oauth2Providable::AccessToken, Devise::Oauth2Providable::AuthorizationCode, Devise::Oauth2Providable::Client, Devise::Oauth2Providable::RefreshToken, Product, User]
  ...
  #     configure :refresh_token, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  ...
  #     configure :authorization_codes, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
